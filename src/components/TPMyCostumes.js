  ...
  <div className="nextReport annotationBlock">
    ...
    <ul className="characterList">
      <li className="characterListItem">
        <img alt="Ben as Bob" src="images/benbob.png" height="100px"/>
        <div className="characterTitle">BOB</div>
        <div>2014</div>
      </li>
      <li className="characterListItem">
        <img alt="Ben as Cooper" src="images/bencoop.png" height="100px"/>
        <div className="characterTitle">Agent Cooper</div>
        <div>2016</div>
      </li>
      <li className="characterListItem">
        <img alt="Ben as Evil Dale" src="images/benevil.png" height="100px"/>
